...
document.getElementById("request-resume").addEventListener("click", function () {
    ...
    emailjs.send(window.EMAILJS_CONFIG.SERVICE_ID, window.EMAILJS_CONFIG.TEMPLATE_ID, {
        ...
        userName: userName,  
        reply_to: userEmail, 
        email: "chethanbk25@gmail.com", 
        portfolio: "https://chethan-portfolio-two.vercel.app/", 
        linkedin: "https://www.linkedin.com/in/chethan-b-4a01bb208/?originalSubdomain=in", 
        github: "https://github.com/Chethanbkbit123", 
